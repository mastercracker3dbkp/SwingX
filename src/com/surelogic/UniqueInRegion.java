 ...
 * it permits there to be <code>&#64;ReadOnly</code> aliases.
 ...
 * </pre>
 * 
 * In this example, the non-{@code final} field {@code family} is mapped into
 * the {@code ContactData} region but {@code final} field {@code friends} is
 * not. The state of the objects referenced by both fields is mapped into the
