 ...
 * {@code this:RegionName} (see below). If <b>RegionName</b> is a {@code static}
 * region, it must be a region declared in the annotated class or one of its
 * ancestors, and is thus a short hand for {@code pkg.C:RegionName} below.
 ...
 * </dl>
 * 
 * Arguments to methods can be referenced by name or by position using the
 * name <tt>arg</tt><i>n</i>
 * where <i>n</i> is an non-negative integer. The parameter count starts at
 * zero. For example, the declaration below
 * 
 * <pre>
 ...
 * </pre>
 * 
 * <p>Naming arguments by position is mostly used when annotating library
 * methods using XML.
 * 
 * <h3>Semantics:</h3>
 * 
 ...
 * <dl>
 * <dt>this:RegionName</dt>
 * <dd>The target denotes the runtime region {@code RegionName} of the object
 * <em>o</em> referenced by the method/constructor's receiver.
 * <dt>param:RegionName</dt>
 * <dd>The target denotes the runtime region {@code RegionName} of the object
 * <em>o</em> referenced by the parameter {@code p}
 * <em>at the start of the method's execution</em>.
 * <dt>pkg.C.this:RegionName</dt>
 * <dd>The target denotes the runtime region {@code RegionName} of the object
 * <em>o</em> referenced by the qualified receiver <code>pkg.C.this</code>.
 * <dt>any(pkg.C):RegionName</dt>
 * <dd>Let <em>X</em> be the set of all heap objects <em>o</em> such that
 * <em>o</em> has type {@code T} and {@code T instanceof pkg.C}. The target
 * denotes the union of the runtime regions {@code RegionName} of each
 * <em>o</em> &isin; <em>X</em>
 * <dt>pkg.C:Region</dt>
