 ...
 * annotation is applied cannot be used to mutate the referenced object. A read-only reference
 * differs from a an {@link Immutable immutable} reference in that <code>&#064;ReadOnly</code> does not
 ...
 * <code>&#064;ReadOnly</code> unless the callee wishes to retain a reference.
 * <p>
 * A {@link Borrowed} field may be annotated <code>&#064;ReadOnly</code> to indicate that the field
 * cannot be used for mutation.
 * <p>
 * It is a modeling error to annotate a primitive type.  For example
 * <pre>
 * &#64;ReadOnly("return") public int getValue() { &hellip; }
 *</pre>
 * and 
 * <pre>
 * public void setValue(&#64;ReadOnly int value) { &hellip; }
 * </pre>
