 ...
 * if the formal argument or receiver, respectively, is {@link Borrowed}. That is,
 ...
 * <p>
 * Setting the <tt>allowRead=true</tt> attribute weakens the uniqueness
 * guarantees: it permits there to be <code>&#64;ReadOnly</code> aliases.
 * In other words, only the ability to write (mutate) is restricted to this
 * alias. Once a unique reference has granted <tt>allowRead</tt>, there is no
 * going back, unlike with (temporary) borrowed references.
 * <em>This attribute is not currently 
 ...
 * instead.
 * <p>
 * It is a modeling error to annotate a reference if the type is primitive.
 * For example,
 * <pre>
...
public @interface Unique {
   ...
   * checked by analysis</em>.
   */
  public boolean allowRead() default false;
}
