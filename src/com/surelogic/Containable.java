 ...
 * <code>&#064;ReferenceObject</code> is used instead. Unlike
 * bounds introduced with <tt>&#064;AnnotationBounds</tt>, these bounds are only
 ...
 * non&ndash;thread-safe Java collection classes such as
 * <code>java.util.ArrayList</code> and <code>java.util.HashMap</code>.  This
 ...
 * only use the <code>hashCode()</code>, <code>equals()</code>,
 * and <code>toString()</code> methods of the objects in the collection.  They
 ...
 * 
 * <p>The non&ndash;thread-safe collection classes in 
 * <code>java.util</code> and <code>java.util.concurrent</code> such as
 * <code>ArrayList</code>, <code>LinkedList</code>, <code>HashSet</code>,
 * and <code>HashMap</code> have been annotated as <code>&#064;Containable</code>.
 ...
 * </pre>
 * 
 * <p>The class below shows the use of annotation bounds and conditional 
 * containability:
 * 
 * <pre>
 * &#064;Containable
 ...
 * </pre>
 * 
 * <p>The type formal <tt>E</tt> has the annotation bound <code>&#064;ThreadSafe</code>.
 * The field <tt>stringList</tt> is containable because the the immutable
 * type <code>String</code> satisfies the thread-safe bound of 
 * <code>ArrayList</code> allowing the type to be considered
 ...
 * is not containable, however, because the type <code>HashSet&lt;Object&gt;</code>
 * is not <code>&#064;Containable</code>, due to <code>Object</code> not
 * being <code>&#064;ThreadSafe</code>.
 * 
 * <p>This example also demonstrates how the <a href="#fieldrules">above rules</a> for fields of a 
 * <code>&#064;Containable</code> class may be made less conservative.  If
 * the field is <code>final</code> the declared type of field does not have to
 * be <code>&#064;Containable</code> (indeed, <code>java.util.List</code>,
 * <code>java.util.Set</code>, and <code>java.util.Map</code> are not 
 * annotated to be <code>&#064;Containable</code>), as long as the initializer of the field
