 ...
 * <p>
 * An annotation type declaration may be annotated with <code>&#064;ThreadSafe</code>
 ...
 * instance part and the static part are checked to be thread-safe.</li>
 * <li><tt>&#064;Immutable(appliesTo=Part.Instance)</tt> &mdash; The instance
 * part only is checked to be thread-safe.</li>
