 ...
 * attributes. A value objects has no meaningful identity separate from the
 * value of its fields. Some examples of types that define value objects include
 ...
 * {@code Point} implementation to be immutable as shown in the example code
 * below.
 * 
 * <pre>
 * &#064;Immutable
